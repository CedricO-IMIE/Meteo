...
function insertOrUpdateMeteo($lieu, $temperature, $lat, $lon, $humidite, $pression, $ventv, $ventdir, $temps) {
    ...
    $result = mysqli_query($database, "SELECT * FROM meteo WHERE Lieu like '".$lieu."'");
